...
/* Pintar */
pintar {return textColor(yychar, yylength(), new Color(212, 129, 06));}
...
/* Repetir */
repetir |
repetirMientra {return textColor(yychar, yylength(), new Color(121, 107, 255));}
...
/* Estructura si */
si |
sino {return textColor(yychar, yylength(), new Color(48, 62, 129));}
